  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full">
      ...
      <div className="flex flex-col gap-8">
        <div data-rf="stack-x" className="flex flex-row grow gap-8 wrap md:flex-nowrap p-1">
            <div
            className="flex relative overflow-hidden [&>*:not(.data-rf-layer)]:z-10 flex-col rounded-3xl aspect-[2.5] sm:aspect-[1.8] grow md:basis-1/3 max-h-[400px] bg-gradient-to-b from-indigo-400/40 hover:to-[#cc5bdd] p-px"
            >
            <div className="flex flex-col hug md:pt-5 md:pl-5 lg:pt-7 lg:px-7 md:gap-8 rounded-3xl">
                ...
                <div className="flex flex-row grow pl-5 relative min-h-[200px] md:min-h-full">
                <div className="flex flex-row overflow-hidden absolute inset-0 scale-[1.1] origin-top-left h-auto w-auto">
                </div>
                </div>
            </div>
            ...
            <div className="flex flex-col grow hug md:pt-5 md:pl-5 lg:pt-7 lg:px-7 md:gap-8 rounded-3xl">
                ...
                <div data-rf="stack-x" className="flex flex-row w pl-5 relative min-w-full min-h-[200px] md:min-h-full">
                <div className="flex flex-row overflow-hidden absolute inset-0 scale-[1.1] origin-top-left h-auto w-auto"></div>
                </div>
            </div>
            <div className="flex absolute data-rf-layer flex-row inset-[1px] bg-slate-950 rounded-3xl"></div>
            </div>
        ...
        <div
            className="flex relative overflow-hidden [&>*:not(.data-rf-layer)]:z-10 flex-col rounded-3xl md:aspect-[2.5] grow md:basis-2/3 max-h-[400px] bg-gradient-to-b md:bg-gradient-to-r from-indigo-400/40 to-indigo-400/10 md:to-indigo-400/0 hover:to-[#cc5bdd] p-px"
        >
            ...
            <div data-rf="stack-x" className="flex flex-row grow relative basis-6/12 aspect-[1.5]">
                <div className="flex flex-row relative overflow-hidden h-full w-full md:origin-center grayscale-[95%]"></div>
            </div>
            </div>
            <div className="flex absolute data-rf-layer flex-row inset-[1px] bg-slate-950 rounded-3xl"></div>
        </div>
